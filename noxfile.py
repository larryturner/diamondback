                ...
                method = textwrap.dedent(
                    ...
                    with TestClient( app ) as client :
                        ...
                        try:
                            ...
                            for x, y in item[ 'paths' ].items( ) :
                
                                for u, v in y.items( ) :
                
                                    del item[ 'paths' ][ x ][ u ][ 'parameters' ]
                    ...
                    with open( 'sphinx/openapi.json', mode = 'w', encoding = 'utf-8' ) as fin :
                
                        json.dump( item, fin )
                    """
                )

                session.run( 'python', '-c', method )
    ...
    if ( os.path.exists( '.git' ) ) :
        ...
        for account in ( 'SESA14073', ) :
            ...
            try :
                ...
                url = 'https://github.schneider-electric.com/' + account + '/' + repository + '.git'
