...
try :
    ...
    description = ''
name = 'diamondback'
with open( os.path.join( name, '__init__.py' ), 'r' ) as fin :
...
setup( name = name,
       ...
       install_requires = [ 'jsonpickle >= 2.2.0, < 3.0.0',
                            'loguru >= 0.6.0, < 1.0.0',
                            'numpy >= 1.23.0, < 2.0.0',
                            'pandas >= 1.4.3, < 2.0.0',
                            ...
                            'scipy >= 1.8.1, < 2.0.0' ],
       extras_require = dict( full = [ 'ipython >= 8.4.0, < 9.0.0',
       ...
       setup_requires = [ 'build >= 0.8.0, < 1.0.0',
                          'setuptools >= 63.1.0, < 64.0.0',
                          'wheel >= 0.37.1, < 1.0.0' ],
       keywords = [ 'BSON',
                    'DSP',
                    'FFT',
