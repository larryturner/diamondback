...
class Test( object ) :
    ...
    def test_IirFilter( self ) :
        ...
        z = numpy.array( [ 1.753654971914e-08,  1.456067183425e-07,  3.895529756880e-07, -7.390432379724e-07,
                          -1.039304228348e-05, -4.907830466681e-05, -1.610293252688e-04, -4.253892439800e-04,
                          -9.659936397280e-04, -1.957319287929e-03, -3.624159774970e-03, -6.233451546404e-03,
                          -1.007803925531e-02, -1.545316856035e-02, -2.262720984575e-02, -3.180913888176e-02,
                          -4.311629168853e-02, -5.654606814920e-02, -7.195477308227e-02, -8.904638597528e-02,
                          -1.073735611528e-01, -1.263519372073e-01, -1.452872172607e-01, -1.634133228871e-01,
                          -1.799391268515e-01, -1.941002279746e-01, -2.052112711932e-01, -2.127142284713e-01 ] )
        x = ComplexExponentialFilter( 0.5 ).filter( numpy.ones( len( z ) ) * 0.1 ).real
        n = ComplexExponentialFilter( 0.0 ).filter( numpy.ones( len( z ) ) * 0.5 ).real * 0.1
        d = x + n
        y = obj.filter( d )
        ...
        z = numpy.array( [ 0.100000000000,  0.099999928273,  0.099999044643,  0.099993654638,
                           0.099971704264,  0.099903792042,  0.099731727295,  0.099356711892,
                           0.098629435885,  0.097344537594,  0.095241822188,  0.092015733855,
                           0.087333189226,  0.080858870433,  0.072286360297,  0.06137248622 ,
                           0.047971259902,  0.032063657924,  0.01377999136 , -0.006587971867,
                          -0.028587460781, -0.051618820228, -0.074962750943, -0.097818954524,
                          -0.119353657877, -0.138752440686, -0.155273822427, -0.168298973585 ] )
        y = obj.filter( d )
        assert numpy.allclose( y, z )
